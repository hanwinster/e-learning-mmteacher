                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">
                                @can('add_college')
                                    <a href="{{ route('admin.college.create') }}" class="btn btn-primary btn-md">{{ __('New') }}</a>
                                @endcan
                            </h4>
                            <div class="card-tools">
                                <form action="{{ route('admin.college.index') }}" method="get">
                                    ...
                                    <a href="{{ route('admin.college.index') }}" class="btn btn-secondary btn-md">{{ __('Reset') }}</a>                                
                                </form> 
                            </div>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right table-options">
                                        @can('edit_college')
                                            ...
                                            href="{{ route('admin.college.edit', $post->id) }}" data-provide="tooltip"
                                            title="Edit"><i class="fas fa-edit"></i></a>
                                        @endcan

                                        @can('delete_college')
                                            {!! Form::open(array('route' => array('admin.college.destroy', $post->id), 'method' => 'delete' , 
