...
@section('title', __('User\'s Submitted Answers'))
            ...
            <div class="row mb-2">
                <div class="col-12">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('member.course.show', [$courseId] )}}#nav-assessment">
                            {{ strip_tags($long_answer->question) }}</a>
                        </li>
                    ...
                    <div class="card card-outline card-info">
                        <div class="card-header">
                            <h5>{{ __('Manage Submitted Answer(s) of') }}&nbsp;
                                {{ strip_tags($long_answer->question) }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                        ...
                        <!------------------- Modal Start -------------------------->
                          <div id="assess-long-answer-modal" class="modal fade" role="dialog">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form"> 
                                        @csrf
                                        <input type="hidden" class="form-control" id="assessment_user_id" value="{{$answer->id}}">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="assessstatus" class="form-control" name="status"> 
                                                <!-- <option value="{{$answer->comment}}" selected>{{$answer->comment}}</option> -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea  v-validate="'required|max:255'" name="comment" placeholder="Comment..." rows="10"  id="assesscomment"  
                                  ...
                                  <div class="modal-footer user-assess-la-feedback">
