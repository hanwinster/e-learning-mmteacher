...
@if (isset($post->id)) 
    @section('title', __('Edit Summary'))
@else 
    @section('title', __('New Summary'))
@endif
            ...
            <div class="row mb-2">
                <div class="col-12">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('member.course.show', $course->id)}}#nav-summary">{{ __('Summaries') }}</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row gap-y">
                ...
                <div class="col-12" id="Summary_root">
                    <div class="card card-outline card-info">
                        ...
                        <div class="card-body"> <!-- '@submit' => 'validateBeforeSubmit' -->
                            @if (isset($post))
                            {!! \Form::open(array('files' => true, 'method' => 'put', 'route' => array('member.summary.update',
                            $post->id), 'class' => 'form-horizontal')) !!}
                            @else
                            {!! \Form::open(array('files' => true, 'route' => ['member.summary.store', $course->id],
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="title">
                                            @lang('Summary Title')&nbsp;<span class="required">*</span>
                                        </label>
                                    ...
                                    <div id="lecture-attach-file" class="form-group">
                                        ...
                                        @if(isset($post->id))
                                            ...
                                            <div style="padding: 10px 0px;">
                                                @if(count($post->getMedia('summary_attached_file')))
                                                    @foreach($post->getMedia('summary_attached_file') as $resource)
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('member.course.show', $course->id).'#nav-summary' }}" class="btn btn-outline-dark">{{ __('Cancel') }}</a>
                            </div>
                            </form>
                        </div>
